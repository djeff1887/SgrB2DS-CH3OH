...
for core in source:
    ...
    err_abund=fits.getdata(abunsnrmap)*abundances
    if i!=9:
        corerad=1500*u.AU
    else:
        corerad=20000#radii[i]
...
compositepath='/blue/adamginsburg/d.jeff/imaging_results/SgrB2DS-CH3OH/t150_compositehotcoresummarytable.fits'
