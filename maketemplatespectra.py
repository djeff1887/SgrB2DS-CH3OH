...
otherspecies=[' CH3OCHO ',' HOONO ',' HNCO ',' H2CO ','C2H5OH']#' g-CH3CH2OH ' ' C3H6O2 ' skeptical looking at full spectrum, removing DCN b/c it causes issues here
specplotnames=[' CH$_3$OCHO ',' HOONO ',' C$_3$H$_6$O$_2$ ',' g-CH$_3$CH$_2$OH ',' HNCO ',' DCN ',' H$_2$CO ',' C$_2$H$_5$OH']
