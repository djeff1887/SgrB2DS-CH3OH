...
fig=plt.figure()
plt.errorbar(wbsmm1trot.value,wbsmm1mass.value,xerr=trotwb_err.value,fmt='o',label='WB 89789 SMM1')
plt.errorbar(w51trot,w51mass,fmt='o',label='W51 e2e')
plt.errorbar(coretrots.value,coremasses,xerr=trotcore_errs.value,yerr=err_coremasses,fmt='o',label='CORE catalogue')
plt.errorbar(temps,dsmasses,xerr=errortemps,yerr=errormass,fmt='o',label='DS Hot Cores')
plt.xscale('log')
plt.yscale('log')
...
plt.figure()
plt.scatter(wbsmm1mass,wbsmm1radius,label='WB 89789 SMM1')
plt.scatter(w51mass,w51radius,label='W51 e2e')
plt.scatter(coremasses,coreradii,label='CORE catalogue')
plt.scatter(dsmasses,dsradii,label='DS Hot Cores')
plt.xscale('log')
plt.yscale('log')
...
plt.figure()
plt.errorbar(coremasses,dindices,yerr=err_dindices,fmt='o',label='CORE Catalogue')
plt.errorbar(dsmasses,dsdensindex,yerr=err_dsdens,fmt='o',label='DS Hot Cores')
plt.xlabel('M$_{core}$ (M$_\odot$)',fontsize=14)
