...
home='/blue/adamginsburg/d.jeff/imaging_results/SgrB2DS-CH3OH/Mom0/field1/spw0/'#Make sure to include slash after path
fname='/blue/adamginsburg/d.jeff/imaging_results/SgrB2DS_field1_spw0_cube_minimize_medsub.image.fits'
cube=sc.read(fname)
...
def linelooplte(line_list,line_width,iterations,quantum_numbers):
    ...
    for i in range(iterations):
        ...
        if tbthick >= 3*targetspecK_stddev*u.K:
